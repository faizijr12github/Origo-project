                        ...
                        >
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/Home Textiles/Madeups/Curtains/Curtains 1.webp"
                                            alt="Curtains 1"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/Home Textiles/Madeups/Curtains/Curtains 3.webp"
                                            alt="Curtains 3"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/Home Textiles/Madeups/Curtains/Curtains 4.webp"
                                            alt="Curtains 4"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/Home Textiles/Madeups/Curtains/Curtains 5.webp"
                                            alt="Curtains 5"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/Home Textiles/Madeups/Curtains/Curtains 6.webp"
                                            alt="Curtains 6"
                                            layout="responsive"
                                            width={100}
                                            height={100}
