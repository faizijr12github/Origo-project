                        ...
                        >
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/towels/Hand Towels/Hand Towels 1.webp"
                                            alt="Hand Towels 1"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/towels/Hand Towels/Hand Towels 3.webp"
                                            alt="Hand Towels 3"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/towels/Hand Towels/Hand Towels 4.webp"
                                            alt="Hand Towels 4"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/towels/Hand Towels/Hand Towels 5.webp"
                                            alt="Hand Towels 5"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/towels/Hand Towels/Hand Towels 6.webp"
                                            alt="Hand Towels 6"
                                            layout="responsive"
                                            width={100}
                                            height={100}
