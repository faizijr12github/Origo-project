                                    ...
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#WomenTShirts" className='text-decoration-none slider-link fw-bold text-dark'>Women T-Shirts</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#WomenHoodies" className='text-decoration-none slider-link fw-bold text-dark'> Women Hoodies</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#WomenSkirts" className='text-decoration-none slider-link fw-bold text-dark'>Women Skirts</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#WomenTrousers" className='text-decoration-none slider-link fw-bold text-dark'> Women Trousers</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#WomenDenimJeans" className='text-decoration-none slider-link fw-bold text-dark'>Women Denim Jeans</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#WomenTankTops" className='text-decoration-none slider-link fw-bold text-dark'>Women Tank Tops</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#WomenShorts" className='text-decoration-none slider-link fw-bold text-dark'>Women Shorts</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#WomenSwimsuits" className='text-decoration-none slider-link fw-bold text-dark'>Women Swimsuits</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#ChildrenTShirts" className='text-decoration-none slider-link fw-bold text-dark'>Children T-Shirts</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#ChilcrenPoloShirts" className='text-decoration-none slider-link fw-bold text-dark'>Children Polo Shirts</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#ChildrenPajamas" className='text-decoration-none slider-link fw-bold text-dark'>Children Pajamas</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#ChildrenRomper" className='text-decoration-none slider-link fw-bold text-dark'>Children Rompers</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#ChildrenSkirts" className='text-decoration-none slider-link fw-bold text-dark'>Children Skirts</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#ChildrenShorts" className='text-decoration-none slider-link fw-bold text-dark'>Children Shorts</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#MensTShirts" className='text-decoration-none slider-link fw-bold text-dark'>Men T-Shirt</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#MensPoloShirts" className='text-decoration-none slider-link fw-bold text-dark'>Men Polo Shirt</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#MensNightwear" className='text-decoration-none slider-link fw-bold text-dark'>Men Nightwears</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#MensTrousers" className='text-decoration-none slider-link fw-bold text-dark'>Men Trousers</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#MensDenimJeans" className='text-decoration-none slider-link fw-bold text-dark'>Men Denim Jeans</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <Card className='border-0 htcards' style={{ width: '100%' }}>
                                            ...
                                            <Card.Body className='px-0 mt-1 text-center'>
                                                <Link href="#MensHoodedJackets" className='text-decoration-none slider-link fw-bold text-dark'>Men Hooded Jackets</Link>
                                            </Card.Body>
                                        </Card>
                                    </SwiperSlide>
                                </Swiper>
