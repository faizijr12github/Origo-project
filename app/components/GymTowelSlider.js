                        ...
                        >
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/towels/Gym Towels/Gym Towel 1.webp"
                                            alt="Gym Towel 1"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/towels/Gym Towels/Gym Towel 2.webp"
                                            alt="Gym Towel 2"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/towels/Gym Towels/Gym Towel 3.webp"
                                            alt="Gym Towel 3"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/towels/Gym Towels/Gym Towel 4.webp"
                                            alt="Gym Towel 4"
                                            layout="responsive"
                                            width={100}
                                            height={100}
                            ...
                            <SwiperSlide>
                                <Card className="expertise-card" style={{ width: '100%' }}>
                                    <div className='img-container'>
                                        <Image
                                            src="/images/towels/Gym Towels/Gym Towel 6.webp"
                                            alt="Gym Towel 6"
                                            layout="responsive"
                                            width={100}
                                            height={100}
