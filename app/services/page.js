        ...
        <>
                ...
                <Container>
                    <Row className='justify-content-between align-items-center pb-3'>
                        <Col className='mt-5' lg="5">
                            <h2 className='mb-3 text-orange fw-bold'>Range of Business Services </h2>
                        ...
                        <Col lg="5" className='mt-5'>
                            <div><img src='/images/services-hero.png' alt='services' className='img-fluid rounded-circle shadow float-animation' width={550} height={550} /></div>
                        </Col>
                    </Row>
                </Container>
            </Container>
            ...
            <Container className='mt-5'>
                <Row className='justify-content-around align-items-center'>
                    ...
                    <Col lg="5" className='mb-5'>
                        <img src='/images/crousel-img2.jpg' alt='mission' className='img-fluid rounded shadow' />
                    </Col>
                </Row>
            </Container>
            <Container className='mt-5'>
                <Row className='justify-content-around align-items-center'>
                    ...
                    <Col lg="5" className='mb-5'>
                        <h2 className='fw-bold'>Project Execution</h2>
            ...
            <Container className='mt-5'>
                <Row className='justify-content-around align-items-center'>
                    ...
                    <Col lg="5" className='mb-5'>
                        <img src='/images/crousel-img4.jpg' alt='mission' className='img-fluid rounded shadow' />
                    </Col>
                </Row>
            </Container>
            <Container className='mt-5'>
